...
# if choix_page == "Théorie"
    ...
    st.markdown(
        ...
        'résultats pour l’an <i>n</i>&nbsp;». <i>En deuxième lieu</i>, cinq graphiques représentent la variation calorique instantanée pour les différentes espèces. On comprend ainsi que le bilan '
        'annuel pour une population donnée correspond à l’aire sous la courbe qui lui appartient. <i>En troisième lieu</i>, on retrouve un schéma illustrant les échanges énergétiques au sein des '
